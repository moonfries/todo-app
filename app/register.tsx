    ...
    return (
        <View style={{ padding: 10, marginTop: 100 }}>
            ...
            <View style={{ marginVertical: 10, gap: 10 }}>
                <Button disabled={onAddUserMutation.isPending} accessoryLeft={() => onAddUserMutation.isPending ? <Spinner size="tiny" /> : <></>}  onPress={handleSubmit(OnClickSubmit)}>Register</Button>
                <Button  appearance="outline"  onPress={() => router.back()}>Go Back</Button>
            </View>
        </View>
    );
}